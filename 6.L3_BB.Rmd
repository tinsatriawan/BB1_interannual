...
getwd()
#dir <- "../Flux-tower (1)/"
dir <- "G:/.shortcut-targets-by-id/1txCh9lZ7VGCujXGvBaJCMVnuxT-65q4K/Micromet Lab/Projects/2014-Burns\ Bog/Flux-tower (1)"
...
if(run_uncertainty == T){
  ...
  output_dir <- "G:/.shortcut-targets-by-id/1txCh9lZ7VGCujXGvBaJCMVnuxT-65q4K/Micromet Lab/Projects/2014-Burns\ Bog/Flux-tower (1)/flux_data/for_uncertainty" 
  } else { 
    n_iteration <- 1  # iteration for random forest
    n_scen <- 3  # number of u* scenario
    output_dir <- "G:/.shortcut-targets-by-id/1txCh9lZ7VGCujXGvBaJCMVnuxT-65q4K/Micromet Lab/Projects/2014-Burns\ Bog/Flux-tower (1)/flux_data"
  }
...
```{r Gap-fill and partition in REddyProc, echo=FALSE, include=T}
...
for(i in 1:n_iteration){
  ...
  # save result
  saveRDS(RF_FCH4, paste0("G:/.shortcut-targets-by-id/1txCh9lZ7VGCujXGvBaJCMVnuxT-65q4K/Micromet Lab/Projects/2014-Burns\ Bog/Flux-tower (1)/flux_data/RF_results/RF_FCH4_",i))
  
  ############### Results
  # variable importance
  png(paste0("G:/.shortcut-targets-by-id/1txCh9lZ7VGCujXGvBaJCMVnuxT-65q4K/Micromet Lab/Projects/2014-Burns\ Bog/Flux-tower (1)/flux_data/RF_results/FCH4_variable_importance_",i,".png"))
...
L2 <- read.csv(paste("./flux_data/BB_L2",".csv",sep = ""),sep=",",header=TRUE,dec=".")  
met <- read.csv('G:/.shortcut-targets-by-id/1txCh9lZ7VGCujXGvBaJCMVnuxT-65q4K/Micromet Lab/Projects/2014-Burns\ Bog/Flux-tower (1)/met_data/met_merged/met_corrected_gapfilled.csv') 
